...
<meta lang="en-US" content="Search for your constituency candidate" name="description"/>
...
<div id="container">
<div class="item">
<h1 class="header_minister_search">Showing results for "<c:out value="${param.keyword}"/>"</h1>

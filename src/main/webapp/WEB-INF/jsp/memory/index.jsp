			...
			if(mem_val.length==0){
				...
				if(mem_val[0]==mem_val[1]){
					...
					function flipBack(){
						...
						tile_1.style.background = 'url(/Resources/img2/fb_kyc.png) no-repeat';
						tile_1.style.backgroundSize = 'cover';
						tile_1.innerHTML = "";
						tile_2.style.background = 'url(/Resources/img2/fb_kyc.png) no-repeat';
...
<body>
<img src="/Resources/img2/desc.png" id="desc" />

...
<a href="<c:out value="${pageContext.request.contextPath}"/>/web/state/chattisgarh/" id=""><span class="stateSeal"><img src="<c:out value="${pageContext.request.contextPath}"/>/Resources/images/state/seals/chattisgarh.png" /></span><span class="stateName">Chattisgarh</span></a>
...
<a href="<c:out value="${pageContext.request.contextPath}"/>/web/state/mahrastra/" id=""><span class="stateSeal"><img src="<c:out value="${pageContext.request.contextPath}"/>/Resources/images/state/seals/maharashtra.png" /></span><span class="stateName">Maharashtra</span></a>

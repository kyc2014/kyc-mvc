		...
		<div id="personalities">
			<div id="leftPersonalities">
				<div  class="mainPersonalityBlock">
					...
					<div class="mphoto">
						<img src="<c:out value="${pageContext.request.contextPath}"/>/Resources/images/state/west_bengal/cm.png">
				...
				<div class="mainPersonalityBlock">
					...
					<div class="mphoto">
						<img src="<c:out value="${pageContext.request.contextPath}"/>/Resources/images/state/west_bengal/governor.png">
						<div class="mphotoDetails">
			...
			<div id="rightPersonalities">
				...
				<div class="wrapperOthers">
					...
					<img src="<c:out value="${pageContext.request.contextPath}"/>/Resources/images/state/west_bengal/1.png">
						<div class="mphotoDetails">
					...
					<div id="minister2" class="photo">
						<img src="<c:out value="${pageContext.request.contextPath}"/>/Resources/images/state/west_bengal/2.png">
						<div class="mphotoDetails">
					...
					<div id = "minister3" class="photo">
						<img src="<c:out value="${pageContext.request.contextPath}"/>/Resources/images/state/west_bengal/3.png">
						<div class="mphotoDetails">

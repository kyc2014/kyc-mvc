		...
		<div id="personalities">
			<div id="leftPersonalities">
				<div  class="mainPersonalityBlock">
					...
					<div class="mphoto">
						<img src="<c:out value="${pageContext.request.contextPath}"/>/Resources/images/state/maharashtra/cm.png">
				...
				<div class="mainPersonalityBlock">
					...
					<div class="mphoto">
						<img src="<c:out value="${pageContext.request.contextPath}"/>/Resources/images/state/maharashtra/governor.png">
						<div class="mphotoDetails">
			...
			<div id="rightPersonalities">
				...
				<div class="wrapperOthers">
					...
					<img src="<c:out value="${pageContext.request.contextPath}"/>/Resources/images/state/maharashtra/1.png">
						<div class="mphotoDetails">
					...
					<div id="minister2" class="photo">
						<img src="<c:out value="${pageContext.request.contextPath}"/>/Resources/images/state/maharashtra/2.png">
						<div class="mphotoDetails">
					...
					<div id = "minister3" class="photo">
						<img src="<c:out value="${pageContext.request.contextPath}"/>/Resources/images/state/maharashtra/3.png">
						<div class="mphotoDetails">

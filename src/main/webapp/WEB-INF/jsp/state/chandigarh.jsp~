...
/*total assembly const - 126*/
        ...
        chart1.draw(data1, options1);
         ...
         var dataTable = new google.visualization.DataTable();
		  ...
		  dataTable.addRows([
		    ['Bhairab Dutt Pande','',new Date(1984,5,2),new Date(1984,6,3)],
['Kershasp Tehmurasp Satarawala','',new Date(1984,6,3),new Date(1984,7,2)],
['Arjun Singh','',new Date(1985,4,30),new Date(1985,10,14)],
['Hokishe Sema','',new Date(1985,10,14),new Date(1985,10,26)],
['Shankar Dayal Sharma','',new Date(1985,10,26),new Date(1986,3,2)],
['Siddharta Shankar Ray','',new Date(1986,3,2),new Date(1989,11,8)],
['Nirmal Mukarji','',new Date(1989,11,8),new Date(1990,5,14)],
['Virendra Verma','',new Date(1990,5,14),new Date(1990,11,18)],
['Om Prakash Malhotra','',new Date(1990,11,18),new Date(1991,7,7)],
['Surendra Nath','',new Date(1991,7,7),new Date(1994,6,9)],
['Sudhakar Panditrao Kurdukar','',new Date(1994,6,10),new Date(1994,8,18)],
['B.K.N. Chhibber','',new Date(1994,8,18),new Date(1999,10,27)],
['J. F. R. Jacob','',new Date(1999,10,27),new Date(2003,4,8)],
['Om Prakash Verma','',new Date(2003,4,8),new Date(2004,10,3)],
['Akhlaqur Rahman Kidwai','',new Date(2004,10,3),new Date(2004,10,16)],
['Sunith Francis Rodrigues','',new Date(2004,10,16),new Date(2010,0,22)],
['Shivraj Patil','',new Date(2010,0,22),new Date()]
		    ]);
			var options2 = {
				timeline:{

        ...
        chart1.draw(data1, options1);
         ...
         var dataTable = new google.visualization.DataTable();
		  ...
		  dataTable.addRows([
			...
			['Vacant(President\'s rule)','N/A',new Date(1967,3,13),new Date(1967,4,26)],
			...
			['Vacant(President\'s rule)','N/A',new Date(1977,4,29),new Date(1977,6,22)],
			['Bhairon Singh Shekhawat','JP',new Date(1977,6,22),new Date(1980,2,16)],
			['Vacant(President\'s rule)','N/A',new Date(1980,2,16),new Date(1980,6,6)],
			...
			['Vacant(President\'s rule)','N/A',new Date(1992,12,15),new Date(1993,12,4)],

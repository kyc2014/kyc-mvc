...
<div class="assemblyStatesListColumn">
<a href="<c:out value="${pageContext.request.contextPath}"/>/web/state//" id=""><span class="stateSeal"></span><span class="stateName">STATES</span></a>
...
<a href="<c:out value="${pageContext.request.contextPath}"/>/web/state/himachal_pradesh/" id=""><span class="stateSeal"><img src="<c:out value="${pageContext.request.contextPath}"/>/Resources/images/state/seals/himachal_pradhesh.png" /></span><span class="stateName">Himachal Pradesh</span></a>
...
<div class="assemblyStatesListColumn">
<a href="<c:out value="${pageContext.request.contextPath}"/>/web/state//" id=""><span class="stateSeal"></span><span class="stateName">UNION TERRITORIES</span></a>
...
<a href="<c:out value="${pageContext.request.contextPath}"/>/web/state/uttar_pradesh/" id=""><span class="stateSeal"><img src="<c:out value="${pageContext.request.contextPath}"/>/Resources/images/state/seals/uttar_pradesh.png" /></span><span class="stateName">Uttar Pradesh</span></a>
...
<a href="<c:out value="${pageContext.request.contextPath}"/>/web/state/west_bengal/" id=""><span class="stateSeal"><img src="<c:out value="${pageContext.request.contextPath}"/>/Resources/images/state/seals/west_bengal.png" /></span><span class="stateName">West Bengal</span></a>
